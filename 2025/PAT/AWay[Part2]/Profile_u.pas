...
begin
  ...
  // Call external class to edit profile details
  TProfileManager.EditProfile(frmLoginRegister.sUserID, memProfile);
...
begin
  ...
  // Terminate application when profile form closes
...
begin
  ...
  // Center memo and controls on screen
...
begin
  ...
  // Load current user's profile into memo
  TProfileManager.LoadProfile(frmLoginRegister.sUserID, memProfile);
