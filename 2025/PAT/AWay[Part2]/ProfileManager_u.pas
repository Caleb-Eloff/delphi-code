...
type
  ...
  public
    class procedure LoadProfile(UserID: string; RichEdit: TRichEdit);
    class procedure EditProfile(UserID: string; RichEdit: TRichEdit);
  end;
...
class procedure TProfileManager.LoadProfile(UserID: string;
  RichEdit: TRichEdit);
var
...
class procedure TProfileManager.EditProfile(UserID: string;
  RichEdit: TRichEdit);
var
